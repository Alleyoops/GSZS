...
public class ResultFragment2 extends NotificationsFragment {
    ...
    private void initView() {
        ...
        recyclerView.setAdapter(new ResultRvAdapter2(R.layout.item_result_fragment_eat));
    }
